...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard'); ?>">Codigo UB</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Proyectos">
          <a class="nav-link" href="<?php echo base_url('admin/proyectos'); ?>">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Categorias">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
              <li><a href="<?php echo base_url('admin/categorias/crear');?>"><i class="fa fa-fw fa-plus"></i>
Agregar Categoria</a></li>
              <?php foreach($categorias as $categoria): ?>
                  <li>
                  <a style="display: inline-block" href="<?php echo base_url('admin/categorias/proyectos/' . $categoria['id']); ?>"> <?php echo $categoria['nombre'] ?></a>
                  <span><a href="<?php echo base_url('categories/borrar/') . $categoria['id'];?>" ><i id="<?php echo 'cat_' . $categoria['id'];?>" onclick="delCat()" class="fa fa-fw fa-times delcat"></i></a></span> 
                </li>
              <?php endforeach ?>
          </ul>
        </li>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Sitio web">
          <a class="nav-link" href="<?php echo base_url(); ?>" target="_blank">
            ...
            <span class="nav-link-text">Sitio web</span>
          </a>
        </li>
      </ul>
