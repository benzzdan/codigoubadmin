    ...
    <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel" data-interval="6000">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <a href="#">
                    ...
                    What image sizes should you use? This can help - https://codepen.io/JacobLett/pen/NjramL
                     -->
                     <picture>
                      <source srcset="<?php echo base_url('assets/images/banner1-nuevo.jpg'); ?>" media="(min-width: 1400px)">
                      <source srcset="<?php echo base_url('assets/images/banner1-nuevo.jpg');?>" media="(min-width: 769px)">
                       <source srcset="<?php echo base_url('assets/images/banner1-nuevo.jpg');?>" media="(min-width: 577px)">
                      <img srcset="<?php echo base_url('assets/images/banner1-nuevo.jpg');?>" alt="responsive image" class="d-block img-fluid">
                    </picture>
            ...
            <div class="carousel-item">
                <a href="#">
                     <picture>
                     <source srcset="<?php echo base_url('assets/images/banner3-nuevo.jpg'); ?>" media="(min-width: 1400px)">
                     <source srcset="<?php echo base_url('assets/images/banner3-nuevo.jpg');?>" media="(min-width: 769px)">
                      <source srcset="<?php echo base_url('assets/images/banner3-nuevo.jpg');?>" media="(min-width: 577px)">
                     <img srcset="<?php echo base_url('assets/images/banner3-nuevo.jpg');?>" alt="responsive image" class="d-block img-fluid">
                    </picture>
            ...
            <div class="carousel-item">
                <a href="#">
                    <picture>
                        <source srcset="<?php echo base_url('assets/images/banner2-nuevo.jpg'); ?>" media="(min-width: 1400px)">
                        <source srcset="<?php echo base_url('assets/images/banner2-nuevo.jpg');?>" media="(min-width: 769px)">
                        <source srcset="<?php echo base_url('assets/images/banner2-nuevo.jpg');?>" media="(min-width: 577px)">
                        <img srcset="<?php echo base_url('assets/images/banner2-nuevo.jpg');?>" alt="responsive image" class="d-block img-fluid">
                    </picture>
