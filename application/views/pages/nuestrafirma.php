<div class="wrapper2">
            ...
            <div id="mySidenav" class="sidenav">
                ...
                <a href="<?php echo base_url('nuestra-firma'); ?>">_02 Nuestra Firma
                    <span class="selector-menu"></span>
                </a>
             ...
             <div class="img-holder">
                <img src="<?php echo base_url('assets/images/nuestra_firma/Panoramica1.png');?>" class="img-fluid" alt="Responsive image">
                <div class="caption">
                    <h1 class="white bold text-center">NUESTRA FIRMA</h1>
